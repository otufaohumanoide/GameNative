...
| K3 | `spec-2026-08-16-K3-deteccao-universal-capacidades.md` | tests `*CapabilityMapping* *Mapping* *Sdl* *Gamepad*` + assemble | ⬜ | — |
| K4 | `spec-2026-08-16-K4-quirks-vidpid.md` | tests `*Quirk* *Gamepad*` + assemble | ⬜ | — |
