...
| J1 | `spec-2026-08-16-J-expressions-dolphin.md` (§2) | tests `*Expr* *Gamepad*` + assemble + sync determinístico | ✅ 2026-08-16 | `e9b7fc19` |
| J2 | `spec-2026-08-16-J-expressions-dolphin.md` (§3, stretch) | tests `*Expr* *Gamepad*` + assemble | ✅ 2026-08-16 | `be4bc6ec` |
